...
<div class="relative">
    <div class="slideshow-container h-[300px] relative overflow-hidden">
        <!-- Slide 1 -->
        <div class="slides bg-cover bg-center" style="background-image: url('{{ asset('banner1.png') }}');">
    ...
    <div class="bg-[#F3F4F6] shadow-md p-8 rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="{{ asset('team/back_end.jpg') }}" alt="Jasmine Nayla" class="object-cover w-full h-full">
                </div>
                <h3 class="mt-4 text-xl font-bold text-blue-600 font-poppins">Jasmine Nayla</h3>
...
<div id="chatbot-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
    <div class="relative w-80 h-[430px] mx-auto mt-20 bg-white rounded-lg shadow-lg">
        ...
        <iframe height="430" width="100%" src="https://bot.dialogflow.com/9a77a1bb-bdf9-4a9a-bc29-9db600342efd"></iframe>
    </div>
</div>
